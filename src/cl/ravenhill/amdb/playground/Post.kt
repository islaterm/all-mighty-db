        ...
        if (!call.request.isMultipart()) {
          ...
          multipart.forEachPart { part ->
            when (part) {
              ...
              is PartData.FileItem -> appendLine(
                "File field: $part = ${part.originalFileName} of ${part.contentType}"
              )
              else -> throw UnsupportedOperationException("Unexpected ${part.contentType}")
            }
            part.dispose()
          }
        }
